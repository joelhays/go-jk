...
func NewJk3doLineParser2() *Jk3doLineParser2 {
	return &Jk3doLineParser2{
		jk3do: Jk3doFile{},
	}
}

func (p *Jk3doLineParser2) Parse3doFromFile(filePath string) Jk3doFile {
...
func (p *Jk3doLineParser2) Parse3doFromString(objString string) Jk3doFile {
	p.jk3do = Jk3doFile{}
...
func (p *Jk3doLineParser2) checkError(err error) {
	if err != nil {
		log.Fatal(err)
	}
}

func (p *Jk3doLineParser2) getNextLine() bool {
	for {
		ok := p.scanner.Scan()
		if !ok {
			p.done = true
...
func (p *Jk3doLineParser2) parseMaterials() {
	var count int
...
func (p *Jk3doLineParser2) parseGeoSets() {
	var count int
...
func (p *Jk3doLineParser2) parseMeshes(geoset *GeoSet) {
	var count int
...
func (p *Jk3doLineParser2) parseVertices(mesh *Mesh) {
	var count int
...
func (p *Jk3doLineParser2) parseTextureVertices(mesh *Mesh) {
	var count int
...
func (p *Jk3doLineParser2) parseVertexNormals(mesh *Mesh) {
...
func (p *Jk3doLineParser2) parseFaces(mesh *Mesh) {
	var count int
...
func (p *Jk3doLineParser2) parseFaceNormals(mesh *Mesh) {
...
func (p *Jk3doLineParser2) parseHierarchyNodes() {
	var count int
